...
begin
  if MessageDlg('Do you want to input Manage claim?', mtConfirmation, [mbYes, mbNo],0) = mrYes then
  begin
    ExecMacro_ClaimManage();
  end;
end;
...
begin
  if MessageDlg('Do you want to input register claim?', mtConfirmation, [mbYes, mbNo],0) = mrYes then
  begin
...
procedure TTaskEditF.ExecMacro_ClaimManage;
var
