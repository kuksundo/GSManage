...
type
  THiconisAsManageF2 = class(TForm)
...
procedure THiconisAsManageF2.SubjectEditKeyPress(Sender: TObject; var Key: Char);
begin
  ExecuteSearch(Key);
end;

procedure THiconisAsManageF2.CurWorkCBDropDown(Sender: TObject);
begin
  g_SalesProcess.SetType2Combo(CurWorkCB);
end;

procedure THiconisAsManageF2.LoadConfig2Form(AForm: TConfigF);
begin
  FSettings.LoadConfig2Form(AForm, FSettings);
end;

procedure THiconisAsManageF2.LoadConfigForm2Object(AForm: TConfigF);
begin
  FSettings.LoadConfigForm2Object(AForm, FSettings);
end;

procedure THiconisAsManageF2.LoadConfigFromFile(AFileName: string);
begin
...
procedure THiconisAsManageF2.LoadGSTask2Grid(ATask: TOrmHiconisASTask; AGrid: TNextGrid;
  ARow: integer);
var
...
procedure THiconisAsManageF2.LoadTaskVar2Grid(AVar: TOrmHiconisASTask; AGrid: TNextGrid;
  ARow: integer);
var
  LIds: TIDDynArray;
  LSubject: string;
...
procedure THiconisAsManageF2.MakeCustReg(ARow: integer);
var
...
procedure THiconisAsManageF2.MakeInvoice(ARow: integer);
var
...
procedure THiconisAsManageF2.MakeQtn(ARow: integer);
var
  LRec: Doc_Qtn_Rec;
begin
...
procedure THiconisAsManageF2.MakeServiceOrder(ARow: integer);
var
...
procedure THiconisAsManageF2.N11Click(Sender: TObject);
var
...
procedure THiconisAsManageF2.N12Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N13Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N14Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N15Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N16Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N18Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N19Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N20Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N21Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
begin
  LTask := GetTask;
...
procedure THiconisAsManageF2.N4Click(Sender: TObject);
var
...
procedure THiconisAsManageF2.oDOList1Click(Sender: TObject);
begin
...
procedure THiconisAsManageF2.PICCBChange(Sender: TObject);
begin
  GetIsRemote(FRemoteIPAddress);
end;

procedure THiconisAsManageF2.ProcessPasteEvent(ATxt: string);
var
  LStr: string;
  LRegexpr: TRegEx;
  LMatch: TMatch;
...
procedure THiconisAsManageF2.ProductTypeComboDropDown(Sender: TObject);
begin
  g_ElecProductType.SetType2Combo(ProductTypeCombo);
end;

procedure THiconisAsManageF2.rg_periodClick(Sender: TObject);
begin
...
procedure THiconisAsManageF2.GetJsonValues1Click(Sender: TObject);
var
  LTask: TOrmHiconisASTask;
  LUtf8: RawUTF8;
  LDynArr: TDynArray;
...
function THiconisAsManageF2.GetMyName(AEmail: string): string;
begin
  Result := GetMyNameNIPAddressFromEmailAddress(AEmail);
end;

function THiconisAsManageF2.GetRecvEmailAddress(AMailType: integer): string;
begin
  case AMailType of
    1: Result := '';//Invoice 송부
...
procedure THiconisAsManageF2.GetSearchCondRec(var ARec: TSearchCondRec);
var
...
function THiconisAsManageF2.GetSqlWhereFromQueryDate(AQueryDate: TQueryDateType): string;
begin
  case AQueryDate of
...
function THiconisAsManageF2.GetTask: TOrmHiconisASTask;
var
  LTaskID: TID;
begin
...
function THiconisAsManageF2.GetTaskIdFromGrid(ARow: integer): TID;
begin
...
function THiconisAsManageF2.GetUserList: TStrings;
var
...
function THiconisAsManageF2.GetUserListFromFile(AFileName: string): TStrings;
var
  LStr: string;
  LUtf8: RawUTF8;
begin
...
function THiconisAsManageF2.Get_Doc_Cust_Reg_Rec(ARow: integer): Doc_Cust_Reg_Rec;
var
  LTask: TOrmHiconisASTask;
  LIdList: TIDList;
  LCustomer: TSQLCustomer;
...
function THiconisAsManageF2.Get_Doc_Inv_Rec(ARow: integer): Doc_Invoice_Rec;
var
  LTask: TOrmHiconisASTask;
  LIdList: TIDList;
  LCustomer: TSQLCustomer;
...
function THiconisAsManageF2.Get_Doc_Qtn_Rec(ARow: integer): Doc_Qtn_Rec;
var
  LQTN: string;
  LTask: TOrmHiconisASTask;
  LIdList: TIDList;
...
function THiconisAsManageF2.Get_Doc_ServiceOrder_Rec(ARow: integer): Doc_ServiceOrder_Rec;
var
  LPeriod:string;
  LTask: TOrmHiconisASTask;
  LIdList: TIDList;
...
function THiconisAsManageF2.Get_Doc_SubCon_Invoice_List_Rec: Doc_SubCon_Invoice_List_Rec;
begin
...
procedure THiconisAsManageF2.grid_ReqCellDblClick(Sender: TObject; ACol,
  ARow: Integer);
var
  LTask: TOrmHiconisASTask;
begin
...
procedure THiconisAsManageF2.grid_ReqKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure THiconisAsManageF2.HullNoEditKeyPress(Sender: TObject; var Key: Char);
begin
  ExecuteSearch(Key);
end;

procedure THiconisAsManageF2.InitTaskEnum;
begin
  g_QueryDateType.InitArrayRecord(R_QueryDateType);
  g_ElecProductType.InitArrayRecord(R_ElecProductType);
end;

procedure THiconisAsManageF2.InitTaskTab;
var
  i: integer;
  LStr: string;
...
procedure THiconisAsManageF2.InputValueClear;
begin
  HullNoEdit.Text := '';
  ShipNameEdit.Text := '';
  CustomerCombo.Text := '';
...
procedure THiconisAsManageF2.Invoice4Click(Sender: TObject);
begin
  MakeInvoice(grid_Req.SelectedRow);
end;

procedure THiconisAsManageF2.GetHullNoToClipboard1Click(Sender: TObject);
begin
...
function THiconisAsManageF2.GetIsRemote(var ARemoteAddr: string): Boolean;
begin
  Result := False;
...
procedure THiconisAsManageF2.DisplayTaskInfo2EditForm(const ATaskID: integer);
var
  LTask: TOrmHiconisASTask;
...
procedure THiconisAsManageF2.AddFolderListFromOL(AFolder: string);
begin
...
procedure THiconisAsManageF2.AeroButton1Click(Sender: TObject);
var
  LRow: integer;
begin
  if grid_Req.SelectedCount > 0 then
...
procedure THiconisAsManageF2.ApplyConfigChanged;
begin
  LoadConfigFromFile;
end;

procedure THiconisAsManageF2.ShowToDoListFromCollect(AToDoCollect: TpjhToDoItemCollection);
begin
  Create_ToDoList_Frm('', AToDoCollect, True,
    nil, nil);//InsertOrUpdateToDoList2DB, DeleteToDoListFromDB);
end;

procedure THiconisAsManageF2.ShowToDoListFormFromList(ATaskId: TID; AToDoList: TpjhToDoList);
begin
  Create_ToDoList_Frm2(ATaskId, AToDoList, True);
end;

procedure THiconisAsManageF2.TaskTabChange(Sender: TObject);
var
  i : Integer;
...
procedure THiconisAsManageF2.btn_SearchClick(Sender: TObject);
var
...
procedure THiconisAsManageF2.Button1Click(Sender: TObject);
begin
  InputValueClear;
end;

procedure THiconisAsManageF2.ComboBox1DropDown(Sender: TObject);
begin
  ComboBox1.Clear;
  g_QueryDateType.SetType2Combo(ComboBox1);
end;

constructor THiconisAsManageF2.Create(AOwner: TComponent);
var
  i: integer;
  LStr: string;
begin
...
procedure THiconisAsManageF2.DeleteTask1Click(Sender: TObject);
var
  LIdList: TIDList;
begin
  if grid_Req.SelectedRow = -1 then
...
destructor THiconisAsManageF2.Destroy;
var
  i: integer;
begin
...
procedure THiconisAsManageF2.DisplayTaskInfo2Grid(ASearchCondRec: TSearchCondRec; AFromRemote: Boolean);
var
...
procedure THiconisAsManageF2.DisplayTaskInfo2GridFromJson(AJson: RawUTF8);
var
...
procedure THiconisAsManageF2.EmailButtonClick(Sender: TObject);
begin
  ShowEmailListFormFromData(grid_Req.SelectedRow);
end;

procedure THiconisAsManageF2.ExecuteSearch(Key: Char);
begin
  if Key = Chr(VK_RETURN) then
    btn_SearchClick(nil);
end;

procedure THiconisAsManageF2.FillInUserList;
var
  LStrList: TStrings;
begin
...
procedure THiconisAsManageF2.ShowTaskFormFromDB(AIDList: TIDList; ARow: integer);
var
  LTask: TOrmHiconisASTask;
  LTaskEditConfig: THiconisASTaskEditConfig;
  LResult: integer;
...
procedure THiconisAsManageF2.ShowTaskFormFromDB(ARow: integer);
var
  LIdList: TIDList;
  LIsRemote: Boolean;
  LUtf8: RawUTF8;
...
procedure THiconisAsManageF2.ShowTaskFormFromGrid(ARow: integer);
var
...
procedure THiconisAsManageF2.ShowTaskFormFromJson(AJson: RawUTF8);
var
  LV: variant;
begin
...
procedure THiconisAsManageF2.ShowTaskID1Click(Sender: TObject);
begin
  ShowTaskIDFromGrid;
end;

procedure THiconisAsManageF2.ShowTaskIDFromGrid;
var
  LIdList: TIDList;
begin
  if grid_Req.SelectedRow = -1 then
...
procedure THiconisAsManageF2.ShowTodoListFormFromData(ARow: integer);
var
  LTask: TOrmHiconisASTask;
  LID : TID;
  i: integer;
...
procedure THiconisAsManageF2.ShowTodoListFormFromDBByGridRow(ARow: integer);
var
  LTask: TOrmHiconisASTask;
  LID : TID;
  i: integer;
...
procedure THiconisAsManageF2.SetConfig;
var
  LConfigF: TConfigF;
...
procedure THiconisAsManageF2.SetNetworkInfo(ARootName, APortName, AKeyName: string);
begin
  FRootName := ARootName;
  FPortName := APortName;
...
procedure THiconisAsManageF2.SetUserNameNIPAddressFromRegServer;
var
  LList: string;
begin
...
procedure THiconisAsManageF2.ShipNameEditKeyPress(Sender: TObject; var Key: Char);
begin
  ExecuteSearch(Key);
end;

procedure THiconisAsManageF2.ShowEmailID1Click(Sender: TObject);
begin
  ShowEmailIDFromGrid;
end;

procedure THiconisAsManageF2.ShowEmailIDFromGrid;
var
  LIdList: TIDList;
begin
  if grid_Req.SelectedRow = -1 then
...
procedure THiconisAsManageF2.ShowEmailListFormFromData(ARow: integer);
var
  LTask: TOrmHiconisASTask;
  LID : TID;
...
procedure THiconisAsManageF2.ShowGSFileID1Click(Sender: TObject);
var
