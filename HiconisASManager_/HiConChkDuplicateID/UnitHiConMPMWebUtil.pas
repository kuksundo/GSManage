...
type
  ...
  public
    ...
    class function GetVersionMPMFromIpRec(ARec: TIpListRec): integer;
...
class function THiConMPMWeb.GetVersionMPMFromIpRec(ARec: TIpListRec): integer;
var
  LCon: RawByteString;
  LUrl, LIpAddr: string;
begin
...
class function THiConMPMWeb.GetVersionUrlFromIpAddr(AIpAddr: string): string;
begin
