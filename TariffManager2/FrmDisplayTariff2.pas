...
uses
  ...
  mormot.core.variants, mormot.core.base,  mormot.core.data;
...
uses UnitGSTriffData, UnitStringUtil, CommonData2;
...
begin
  ...
  try
    ...
    begin
      ...
      if LVar = UnAssigned then
      begin
        ShowMessage('There is no tariff data!');
      end
      else
      begin
