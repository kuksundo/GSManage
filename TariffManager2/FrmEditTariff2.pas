...
uses
  ...
  JvExControls, JvLabel, AeroButtons, Vcl.ExtCtrls, AdvEdit, AdvEdBtn, Vcl.ImgList,
  UnitGSTariffRecord2;
...
uses fFrmEditTariffItem2, UnitGSTriffData, CommonData2, FrmSearchCustomer2;
...
begin
  ...
  begin
    ...
    TariffItemGrid.CellsByName['GSWorkType',LRow] := g_GSWorkType.ToString(AGSTariff.GSWorkType);
    TariffItemGrid.CellsByName['GSEngineerType',LRow] := g_GSEngineerType.ToString(AGSTariff.GSEngineerType);
    TariffItemGrid.CellsByName['GSWorkDayType',LRow] := g_GSWorkDayType.ToString(AGSTariff.GSWorkDayType);
    TariffItemGrid.CellsByName['GSWorkHourType',LRow] := g_GSWorkHourType.ToString(AGSTariff.GSWorkHourType);
...
begin
  ...
  ATariffSearchRec.fGSWorkType := g_GSWorkType.ToType(TariffItemGrid.CellsByName['GSWorkType',ARow]);
  ATariffSearchRec.fGSEngineerType := g_GSEngineerType.ToType(TariffItemGrid.CellsByName['GSEngineerType',ARow]);
  ATariffSearchRec.fGSWorkDayType := g_GSWorkDayType.ToType(TariffItemGrid.CellsByName['GSWorkDayType',ARow]);
  ATariffSearchRec.fGSWorkHourType := g_GSWorkHourType.ToType(TariffItemGrid.CellsByName['GSWorkHourType',ARow]);
