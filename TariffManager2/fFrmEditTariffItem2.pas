...
uses CommonData2, FrmSearchCustomer2;
...
begin
  g_GSEngineerType.SetType2Combo(GSEngineerTypeCB);
  g_GSWorkDayType.SetType2Combo(GSWorkDayTypeCB);
  g_GSWorkHourType.SetType2Combo(GSWorkHourTypeCB);
  g_GSWorkType.SetType2Combo(GSWorkTypeCB);
