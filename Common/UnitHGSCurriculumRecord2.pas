...
var
  g_HGSCurriculumDB: TRestClientDB;
...
begin
  ...
  try
    ...
    Result := TSQLHGSCurriculumRecord.CreateAndFillPrepare(g_HGSCurriculumDB.Orm, Lwhere, ConstArray);
