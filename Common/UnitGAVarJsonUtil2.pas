unit UnitGAVarJsonUtil2;

interface

uses System.Classes, Dialogs, System.SysUtils, System.Rtti, Winapi.ActiveX,
...
//  Cromis.Comm.Custom, Cromis.Comm.IPC, Cromis.Threading, Cromis.AnyValue,
  mormot.core.base, mormot.core.variants, mormot.core.datetime, mormot.core.data,
  mormot.core.json,
  mormot.core.text, mormot.core.buffers, mormot.orm.base, mormot.orm.core,
  Generics.Collections, CommonData2, DateUtils, UnitJHPFileRecord, UnitJHPFileData,
  UnitBase64Util2,
  UnitMustacheUtil2, UnitGAMasterRecord2;
...
function MakeGSFile2JSON(ASQLGSFile: TOrmJHPFile): RawUTF8;
...
uses UnitGAMakeReport2, UnitStringUtil, StrUtils, mormot.core.mustache, UnitGAServiceData,
  UnitGSTriffData;
...
//  TDocVariant.New(Lvar);
  ...
  begin
    ...
    LSQLEmailMsg:= TSQLEmailMsg.CreateAndFillPrepare(g_ProjectDB.Orm, LIds);
    try
      LMailCount := 0;
      LSubject := '';
...
begin
  ...
  LEKind_Src := g_GSEngineerType.ToType(UTF8ToString(ASrc.GSEngineerType));
...
  AItem.GSEngineerType := g_GSEngineerType.ToType(UTF8ToString(ADoc.GSEngineerType));
...
  ADoc.GSEngineerType := g_GSEngineerType.ToString(AItem.GSEngineerType);
