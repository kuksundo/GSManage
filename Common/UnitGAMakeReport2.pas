unit UnitGAMakeReport2;

interface

uses Sysutils, Dialogs, Classes, UnitExcelUtil, Word2010, System.Variants,
  CommonData2, mormot.core.variants;
...
uses UnitStringUtil, UnitGAVarJsonUtil2, UnitGAServiceData;
