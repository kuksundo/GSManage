unit UnitTodoCollect2;

interface

uses System.Classes, DateUtils,
  mormot.rest.client, mormot.core.base, mormot.core.data, mormot.core.variants, mormot.core.text,
  TodoList
  ;
...
//    function Compare(Item1, Item2: TpjhTodoItem): integer;
  ...
  TDeleteToDoListFromDB = procedure(ADB: TRestClientURI; ApjhTodoItem: TpjhTodoItem);
  TInsertOrUpdateToDoList2DB = procedure (ADB: TRestClientURI; ApjhTodoItem: TpjhTodoItem; AIdAdd: Boolean);
