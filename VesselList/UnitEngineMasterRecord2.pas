...
function GetEngineMasterFromHullNo(const AHullNo: string): TSQLEngineMaster;
begin
  Result := TSQLEngineMaster.CreateAndFillPrepare(g_EngineMasterDB.Orm,
    'HullNo LIKE ?', ['%'+AHullNo+'%']);
...
begin
  ...
  try
    ...
    Result := TSQLEngineMaster.CreateAndFillPrepare(g_EngineMasterDB.Orm, Lwhere, ConstArray);
