...
uses SysUtils, Forms, VarRecUtils, UnitBase64Util2, UnitFolderUtil2;
...
function GetNationFromNationName(const ANationName: string): TSQLNationRecord;
begin
  Result := TSQLNationRecord.CreateAndFillPrepare(g_NationDB.Orm,
...
begin
  ...
  try
    ...
    Result := TSQLNationRecord.CreateAndFillPrepare(g_NationDB.Orm, Lwhere, ConstArray);
