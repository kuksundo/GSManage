unit UnitVesselMasterRecord2;

interface

uses Classes,
  mormot.core.base, mormot.orm.core, mormot.rest.sqlite3, mormot.core.os,
...
type
  ...
  published
    property Sanction: RawUTF8 read fSanction write fSanction;
...
var
  g_VesselMasterDB,
  g_VesselInfo4SeaWebDB: TRestClientDB;
  VesselMasterModel,
