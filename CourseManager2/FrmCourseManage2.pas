...
function CreateCourseManageForm(var ASubject,ACourseName,AContents: string;
...
uses UnitEnumHelper, UnitExcelUtil, FrmCourseEdit2;
  ...
  try
    ...
    begin
      ...
      begin
        ...
        AContents := LCourseManageF.FContents;
      end;
    end
    else
    begin
...
begin
  ...
  begin
    ...
    FContents := CourseListGrid.CellsByName['Contents', ARow];
