...
uses
  ...
  AdvOfficeButtons, Vcl.ExtCtrls, Vcl.Buttons, CommonData2, UnitElecMasterData;
...
uses UnitVesselData2, UnitEngineMasterData;
  ...
  begin
    ...
    begin
      for i := Succ(epdtNull) to Pred(epdtFinal) do
        ProductTypesGrp.Items.Add(g_ElecProductDetailType.ToString(i));
    end;
  end;
end;
