...
uses
  ...
  AdvOfficePager,
  AdvToolBtn, AdvGroupBox, AdvOfficeButtons,
  AdvSmoothPanel, AdvSmoothExpanderPanel,
  mormot.core.base,
  UnitVesselMasterRecord2, UnitHiMAPRecord2, UnitHiMAPData, UnitGSFileRecord2;
...
uses WinApi.ShellApi, UnitMSBDData, UnitStringUtil, FrmFileSelect,
  DragDropFile, UnitDragUtil, UnitVariantFormUtil2, UnitGeneratorRecord2;
