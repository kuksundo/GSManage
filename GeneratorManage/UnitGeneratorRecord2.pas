...
uses
  ...
  CommonData2,
  UnitVesselMasterRecord2, UnitGSFileRecord2, UnitRttiUtil2;
...
uses SysUtils, Forms, VarRecUtils, Vcl.Dialogs,// UnitGeneratorData,
  UnitMSBDData, UnitFolderUtil2;
...
function GetGeneratorFromTaskID(const ATaskID: TID): TSQLGeneratorRecord;
begin
  Result := TSQLGeneratorRecord.CreateAndFillPrepare(g_GeneratorDB.Orm,
    'TaskID = ?', [ATaskID]);
end;
