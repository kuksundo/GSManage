...
uses
  ...
  CommonData2,
  UnitVesselMasterRecord2, UnitGSFileRecord2;
...
uses SysUtils, VarRecUtils, Vcl.Dialogs, Forms, UnitFolderUtil2;
...
function GetAnsiDeviceFromDeviceNo(const ADeviceNo: string): TSQLAnsiDeviceRecord;
begin
  Result := TSQLAnsiDeviceRecord.CreateAndFillPrepare(g_AnsiDeviceDB.Orm,
...
begin
  ...
  try
    ...
    Result := TSQLAnsiDeviceRecord.CreateAndFillPrepare(g_AnsiDeviceDB.Orm, Lwhere, ConstArray);
