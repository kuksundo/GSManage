...
type
  TSubCompanyEditF = class(TForm)
    ...
    JvLabel5: TJvLabel;
    SubCompanyEdit2: TAdvEditBtn;
    JvLabel6: TJvLabel;
    DefaultProjNoEdit: TEdit;
    JvLabel7: TJvLabel;
    DefaultHullNoEdit: TEdit;
...
begin
  ...
  begin
    ...
    InvoiceGrid.CellsByName['EngineerKind',LRow] := g_GSEngineerType.ToString(TGSEngineerType(LVar.GSEngineerType));
...
begin
  ...
  SubCompanyEdit2.Text := ASubCon.CompanyName2;
...
begin
  ...
  ACustomer.CompanyName2 := SubCompanyEdit2.Text;
...
//    ACustomer.ElecProductTypes := SubConGrid.CellsByName['ElecProductTypes', i];
  ...
  ACustomer.DefaultHullNo := DefaultHullNoEdit.Text;
  ACustomer.DefaultProjNo := DefaultProjNoEdit.Text;
end;
...
//    Result := LIDList4Invoice.fInvoiceFile.GetJSONValues(True, True, soSelect);
  ...
  begin
    ...
    LDoc.EngineerKind := Ord(g_GSEngineerType.ToType(InvoiceGrid.CellsByName['EngineerKind', ARow]));
...
begin
  ...
  ASubCon.CompanyName2 := SubCompanyEdit2.Text;
...
begin
  ...
  SubCompanyEdit2.Text := ADoc.CompanyName2;
...
var
  ...
  LRow: integer;
  LIDList4Invoice: TIDList4JHPFile;
...
begin
  ...
  begin
    ...
    try
      ...
      LFIleListF.FileListFrame1.ApplyButton.Visible := False;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          SubCompanyEdit2.Text := NextGrid1.CellByName['CompanyName2', NextGrid1.SelectedRow].AsString;
          ...
          DefaultProjNoEdit.Text := NextGrid1.CellByName['DefaultProjNo', NextGrid1.SelectedRow].AsString;
          DefaultHullNoEdit.Text := NextGrid1.CellByName['DefaultHullNo', NextGrid1.SelectedRow].AsString;
