...
uses
  ...
  Vcl.ImgList, Vcl.ComCtrls, JvExControls, JvLabel,
  NxEdit, Vcl.Buttons, NxColumnClasses, NxColumns, NxScrollControl, NxCustomGridControl,
  NxCustomGrid, NxGrid, AdvGlowButton, DropSource, DragDrop, DropTarget,
  AdvOfficePager, AdvToolBtn, AdvGroupBox, AdvOfficeButtons,
  mormot.core.base, mormot.core.variants, mormot.core.os, mormot.core.text,
  mormot.core.datetime,
  UnitGSFileRecord2, UnitVesselMasterRecord2, UnitHiMAPRecord2, UnitHiMAPData,
  UnitComboBoxUtil, UnitGSFileData2;
...
uses WinApi.ShellApi, UnitMSBDData, UnitStringUtil, FrmFileSelect,
  DragDropFile, UnitDragUtil, CommonData2, UnitElecServiceData;
