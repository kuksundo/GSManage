...
type
  ...
  published
    ...
    property DivertHullNo: RawUTF8 read fDivertHullNo write fDivertHullNo;
    property DivertClaimNo: RawUTF8 read fDivertClaimNo write fDivertClaimNo;
...
    property ShippingDesc: RawUTF8 read fShippingDesc write fShippingDesc;

    property DivertQty: integer read fDivertQty write fDivertQty;
    property RemainedQty: integer read fRemainedQty write fRemainedQty;
...
    property ReceiveDate: TTimeLog read fReceiveDate write fReceiveDate;
    property DivertDate: TTimeLog read fDivertDate write fDivertDate;
...
function GetStockMaterialByDivertHullNoNClaimNo(ADivertHullNo: RawUTF8; ADivertClaimNo: RawUTF8=''): TOrmStockMaterial;
...
function GetStockMaterialByDivertHullNoNClaimNo(ADivertHullNo: RawUTF8; ADivertClaimNo: RawUTF8=''): TOrmStockMaterial;
begin
  if ADivertClaimNo = '' then
    Result := TOrmStockMaterial.CreateAndFillPrepare(g_HiASStockMaterialDB.orm, 'DivertHullNo = ?', [ADivertHullNo])
  else
    Result := TOrmStockMaterial.CreateAndFillPrepare(g_HiASStockMaterialDB.orm, 'DivertHullNo = ? AND DivertClaimNo = ?', [ADivertHullNo, ADivertClaimNo]);
